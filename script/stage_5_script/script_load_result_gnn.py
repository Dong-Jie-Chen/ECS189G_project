...
from codes.stage_5_code.Result_Loader import Result_Loader
from codes.stage_5_code.Evaluate_Accuracy import Evaluate_Accuracy
from codes.stage_5_code.Evaluate_Classification import Evaluate_Classification
...
if 1:
    ...
    print('GNN Accuracy: ' + str(mean_score))
